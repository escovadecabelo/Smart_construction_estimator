/**
 * GENERATOR MODULE: STANDALONE CLEANING PROPOSAL
 * Produces a high-end, professional proposal for cleaning scopes.
 * Optimized for Mardegan Construction.
 */

export function generateCleaningProposal(data) {
    ...
    const styles = `
        <style>
            ...
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .proposal-container::before { content: ''; position: absolute; top: 0; left: 0; width: 100%; height: 10px; background: linear-gradient(90deg, var(--accent), #34d399); }
            ...
            .intro-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 30px; margin-bottom: 50px; background: #f1f5f9; padding: 25px; border-radius: 20px; }
            ...
            .total-section .value { font-size: 3.2rem; font-weight: 900; color: #34d399; letter-spacing: -2px; }
...
<head>
    <meta charset="UTF-8">
    <title>Cleaning Proposal | Mardegan Construction</title>
    ...
    <div class="proposal-container">
        <header>
            <div class="company-meta">
                ...
                <p class="sub">Post-Construction Sanitization</p>
                <p class="address">904 Valleybrook Dr. Lewisville - TX, 75067</p>
            </div>
            <div class="proposal-meta">
                <h1>Service Proposal</h1>
                <p class="ref">REF: CLN-${Math.floor(Math.random() * 8999) + 1000}</p>
            </div>
        </header>
        ...
        <div class="intro-grid">
            ...
            <div class="info-group"><label>Scope Type</label><p>Sanitization</p></div>
        </div>

        <h2><span>01</span> Phased Service Execution</h2>
        <table class="ledger-table">
            <thead><tr><th>Execution Phase</th><th style="text-align: right;">Subtotal</th></tr></thead>
            <tbody>
                ${data.items.map(item => `
                    <tr>
                        <td>
        ...
        <div class="total-section">
            <div class="total-label">
                <h3>Total Turnover Investment</h3>
                <p>Complete 4-phase sanitization protocol.</p>
            </div>
