...
function App() {
    ...
    const generateNarrative = (items) => {
        ...
        return `This post-construction cleaning engagement covers comprehensive services for ${names}${items.length > 3 ? ' and associated scope items' : ''}. All work will be executed following Mardegan Construction's premium standards for elite quality, precision, and architectural integrity.`;
    };
                ...
                {showMarketModal && (
                    <div className="modal-overlay" onClick={() => setShowMarketModal(false)}>
                        <div className="modal-content market-modal" onClick={e => e.stopPropagation()}>
                            ...
                            <p style={{ color: 'var(--text-dim)', fontSize: '0.8rem', marginBottom: '20px' }}>Reference rates for Post-Construction Cleaning specialized services in Dallas-Fort Worth.</p>
